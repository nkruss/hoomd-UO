...
class Line(Simulation):
    ...
    def create_lattice(self, k1: int, k2: int, k3: int, p_mass=1, N=3, a=1):
        ...
        self.harmonic.bond_coeff.set('polymer1', k=k1, r0=a)
        self.harmonic.bond_coeff.set('polymer2', k=k2, r0=a)
        self.harmonic.bond_coeff.set('polymer3', k=k3, r0=a)
